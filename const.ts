...
export const HOST_NAMES = {
  ...
  CHANNELS_DASHBOARD: 'CHANNELS_DASHBOARD',
  ENTERPRISE_DASHBOARD: 'ENTERPRISE_DASHBOARD'
};
export const METASITE_APP_DEF_ID = '22bef345-3c5b-4c18-b782-74d4085112ff';
export const SHOULD_RENDER_TAGS_PER_PAGE_SPEC =
  'specs.tagManagerRenderTagByPageID';
export const READ_LOAD_ONCE_FROM_TAG_SPEC =
  'specs.tagManager.ReadLoadOnceFromTag';
